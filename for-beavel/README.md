...
└── assets/
    ...
    │   ├── portrait.jpg    # Lock screen portrait
    │   ├── photo1.jpg      # Letter photos
    │   ├── photo2.jpg
    │   └── photo3.jpg
    ├── gallery/            # Gallery & timeline photos
    │   ├── photo1-8.jpg    # 8 polaroid gallery photos
    │   └── memory1-6.jpg   # 6 timeline photos
    ├── hero/               # Hero section images
    ├── videos/
    │   └── background.mp4  # Movie screen background video
    ├── music/
